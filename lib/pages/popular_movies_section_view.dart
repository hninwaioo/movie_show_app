...
class PopularMoviesSectionView extends ConsumerWidget {

  const PopularMoviesSectionView(
    ...
    return Expanded(
      child: RefreshIndicator(
        onRefresh: () {
          ...
          ref.invalidate(fetchPopularMoviesProvider);
              ...
              data: (movies) {
                ...
                return MovieListTile(
                  ...
                  onPressed: () => context.goNamed(
                    AppRoute.best_popular_movie.name,
